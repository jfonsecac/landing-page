            ...
            <div className="flex justify-center container mx-auto my-1 pt-1 w-screen h-screen items-center flex-col">
                ...
                <div className="w-full md:w-3/4  lg:w-1/3 flex flex-col items-center bg-slate-50 rounded-md pt-12">
                    ...
                    <div className="w-3/4 mb-6">
                        <input type="text"  className="w-full py-4 px-8 bg-slate-200 placeholder:font-semibold rounded hover:ring-1 hover:ring-gray-600 outline-slate-500 border-solid border-2 border-slate-300" placeholder="escribe tu usuario" />
                    </div>
                    {/* <!-- password input --> */}
                    <div className="w-3/4 mb-6">
                        <input type="password"  className="w-full py-4 px-8 bg-slate-200 placeholder:font-semibold rounded hover:ring-1 hover:ring-gray-600 outline-slate-500  border-solid border-2 border-slate-300" placeholder="Password" />
                    </div>
                    {/* <!-- button --> */}
