      ...
      <div className='container'>
        {/*header section */}
            <div className='text-center mb-10 max-w-[600px] mx-auto'>
                <p data-aos="fade-up" className='text-sm text-primary  dark:bg-gray-950 dark:text-white'>Proyectos para tu vida Familiar</p>
                <h1 data-aos="fade-up" className='text-3xl text-primary font-bold  dark:bg-gray-950 dark:text-white'>Proyectos Actuales</h1>
                <p data-aos="fade-up" className='text-ms text-gray-400'>
